...
<<<<<<< 3efd695f575183b5ffec2b1b3cae1b7acf06dc53
                        if(animalCommonName)
...
>>>>>>> (species) add in species, styles, ngsanitize, bower.json additgion
                    }
...
{ 
  ...
  if ($nLeftLength == 0) 
    ...
    return $nLeftLength - $nRightLength; 
     ...
     $nsDistance = Array.apply(null, Array($nRightLength + 1)).map(function (_, i) {return i+1;});
